...
! Array declarations.
    ...
    INTEGER I, IAGE, ICC, IDAY, IECO, IECOU, IEND, IFLUSH, IHOUR, IOTC, IJV
    INTEGER IPROG, IPROGUS, IPT, IPTUS, ISIMUS, ISPEC, ISTART, ISUNLIT, ITAR, ITERMAX, ITREE, IPOINTS
    INTEGER SIMSOILEVAP
    INTEGER IWATFILE, IWAVE, IWHICH, JLEAF, JSHAPE, KEEPWET, KEEPDRY, MASPDATE, MFLAG, MODELGS, MODELJM
    INTEGER NUMTESTPNT
    LOGICAL ISMAESPA
    ...
    REAL HISTO(MAXT,MAXHISTO,3)  ! Note dim change (RAD Sept. 08). BM 02/19
